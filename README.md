...
Spotify Web API para buscar músicas e validar resultados
LLM (IA – ex: OpenAI / Gemini) para gerar recomendações inteligentes
Possibilidade de exportar a playlist para o Spotify do usuário
